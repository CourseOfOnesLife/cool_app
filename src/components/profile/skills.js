        ...
        <div className="bg-white h-64 max-xl:w-8/12 w-3/12 rounded-2xl pb-14  border-2">
            ...
            <div className="h-full w-full grid grid-cols-2 grid-rows-2  gap-2 p-4">
                <div className="h-full w-full py-2 px-1 bg-[#582270] rounded-2xl flex content-center">
                    <p className="font-semibold text-lg px-3 text-white">Javascript</p>
                </div>
                <div className="h-full w-full py-2 px-1 bg-[#582270] rounded-2xl flex content-center">
                    <p className="font-semibold text-lg px-3 text-white">SQL</p>
                </div>
                <div className="h-full w-full py-2 px-1 bg-[#582270] rounded-2xl flex content-center">
                    <p className="font-semibold text-lg px-3 text-white">HTML-CSS</p>
                </div>
                <div className="h-full w-full py-2 px-1 bg-[#582270] rounded-2xl flex content-center">
                    <p className="font-semibold text-lg px-3 text-white">React</p>
                </div>
