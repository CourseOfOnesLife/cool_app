...
const Projects = () => {
    return (
        <div className="bg-white  h-64 w-6/12 rounded-2xl max-xl:w-6/12 border-2">
            ...
            <div className="w-full h-0.5  mt-3 bg-gray-200"></div>
                ...
                <div key={index} className="flex flex-col h-full w-full justify-around bg-[#335708] rounded-2xl">
                    <p className="text-white text-2xl font-semibold pt-2 pl-3 max-lg:text-xl max-w-[100px] ">{project.name}</p>
