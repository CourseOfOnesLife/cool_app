...
const ProfilePic = () => {
    return (
        <div className="bg-white h-64 max-lg:h-56 max-lg:w-56 relative w-64  rounded-2xl border-2 flex justify-center items-center overflow-hidden transition-all  filter grayscale-0 hover:grayscale-[20%] ">
