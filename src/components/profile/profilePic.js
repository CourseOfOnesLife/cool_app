...
const ProfilePic = () => {
    return (
        <div className="bg-white  h-full w-[25rem]  max-xl:w-3/12 max-xl:h-[17rem] rounded-2xl border-2 flex justify-center items-center overflow-hidden transition-all  filter grayscale-0 hover:grayscale-[20%] ">
