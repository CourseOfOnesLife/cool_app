        ...
        <div className=" bg-white border-2 border-[#F1EDE7] h-56 w-full rounded-2xl pb-16 pt-8">
            <div className="flex flex-row  space-x-6  h-full items-center px-6 pb-6">
                ...
                <div className="bg-[#E8E8E8] h-full w-full rounded-2xl flex pl-4 pt-3 items-start max-lg:text-[1.4vw] max-xl:text-[1.3vw] text-[1vw] text-start font-semibold text-[#582270] ">
                    Front-end <br />Geliştirici - HTML
                </div>
                <div className="bg-[#582270] h-full w-full rounded-2xl flex pl-4 pt-3 items-start max-lg:text-[1.35vw] max-xl:text-[1.3vw] text-[1vw] text-start font-semibold text-[#E8E8E8] ">
