        ...
        <div className="bg-white border-2 border-[#F1EDE7] max-sm:h-[24rem] max-md:h-[25rem] h-64 w-full rounded-2xl pb-16 pt-8">
            <div className="flex max-md:flex-col flex-row max-md:space-x-0 space-x-6 max-md:space-y-3 h-full items-center px-4 pb-6">
                ...
                <div className="bg-[#335708] max-lg:text-[1.6vw]  h-full w-full rounded-2xl flex items-start max-md:text-[1.1rem]  max-sm:text-[1rem]  max-xl:text-[1.1rem] text-[1.1rem] text-start max-sm:pl-4 pl-5 font-semibold text-[#86EE03] ">
                    <div className="absolute pt-3  max-sm:max-w-[200px] max-md:max-w-[230px] max-lg:max-w-[12rem] max-xl:max-w-[14rem] max-w-[13rem]">
                ...
                {window.innerWidth > 780 ? SlicedData.map((item) => {
                    return (

                        <div key={item.id} className="odd:bg-[#335708] bg-[#E8E8E8] max-lg:text-[1.7vw] max-xl:text-[1.1rem] h-full w-full rounded-2xl flex pl-4 pt-3 justify-between items-start max-md:text-[1rem] max-xl:text-md text-[1.1rem] text-start font-semibold odd:text-[#86EE03] text-[#335708]">
